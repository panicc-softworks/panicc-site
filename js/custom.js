(function($){
	...
	$( document ).ready( function() {
		...
		});$(".service-7").hover(function() {
			var icondraw = anime({
			  targets: '.service-7 path',
			  strokeDashoffset: [anime.setDashoffset, 0],
			  easing: 'linear',
			  duration: 2000,
			  delay: function(el, i) { return i * 250 },
		...
		$(".service-8").hover(function() {
			var icondraw = anime({
			  targets: '.service-8 path',
			  strokeDashoffset: [anime.setDashoffset, 0],
			  easing: 'linear',
			  duration: 2000,
			  delay: function(el, i) { return i * 250 },
		...
		});$(".service-9").hover(function() {
			var icondraw = anime({
			  targets: '.service-9 path',
			  strokeDashoffset: [anime.setDashoffset, 0],
			  easing: 'linear',
			  duration: 2000,
			  delay: function(el, i) { return i * 250 },
		...
		$(".service-10").hover(function() {
			var icondraw = anime({
			  targets: '.service-10 path',
			  strokeDashoffset: [anime.setDashoffset, 0],
			  easing: 'linear',
			  duration: 2000,
			  delay: function(el, i) { return i * 250 },
		...
		});$(".service-11").hover(function() {
			var icondraw = anime({
			  targets: '.service-11 path',
			  strokeDashoffset: [anime.setDashoffset, 0],
			  easing: 'linear',
			  duration: 2000,
			  delay: function(el, i) { return i * 250 },
		...
		});$(".service-12").hover(function() {
			var icondraw = anime({
			  targets: '.service-12 path',
			  strokeDashoffset: [anime.setDashoffset, 0],
			  easing: 'linear',
			  duration: 2000,
			  delay: function(el, i) { return i * 250 },
